                                ...
                                <select
                                  ...
                                  {...register("alcohol", {
                                    required: {
                                      value: true,
                                      message:
                                        "*Please Enter Alcohol Consuming Habit",
                                    },
                                  })}
                                >
                              ...
                              <div className="col-sm-12">
                                <select
                                  ...
                                  {...register("smoking", {
                                    required: {
                                      value: true,
                                      message: "*Please Enter Smoking Habit",
                                    },
                                  })}
                                >
                            ...
                            <div className="card-body">
                              ...
                              <div className="progress mb-3 progressbarCharacterType">
                                <div
                                  ...
                                  aria-valuenow={user.user.extraversionValue}
                                  aria-valuemin="0"
                                  aria-valuemax="100"
                                >
                                  {user.user.extraversionValue}%
                                </div>
                                <div
                                  ...
                                  aria-valuenow={user.user.introversionValue}
                                  aria-valuemin="0"
                                  aria-valuemax="100"
                                >
                                  {user.user.introversionValue}%
                                </div>
                              </div>
                              ...
                              <div className="progress mb-3 progressbarCharacterType">
                                <div
                                  ...
                                  aria-valuenow={user.user.sensingValue}
                                  aria-valuemin="0"
                                  aria-valuemax="100"
                                >
                                  {user.user.sensingValue}%
                                </div>
                                <div
                                  className="progress-bar progress-bar-striped bg-danger"
                                  role="progressbar"
                                  ...
                                  aria-valuenow={user.user.intuitionValue}
                                  aria-valuemin="0"
                                  aria-valuemax="100"
                                >
                                  {user.user.intuitionValue}%
                                </div>
                              </div>
                              ...
                              <div className="progress mb-3 progressbarCharacterType">
                                <div
                                  ...
                                  aria-valuenow={user.user.thinkingValue}
                                  aria-valuemin="0"
                                  aria-valuemax="100"
                                >
                                  {user.user.thinkingValue}%
                                </div>
                                <div
                                  className="progress-bar progress-bar-striped bg-danger"
                                  role="progressbar"
                                  ...
                                  aria-valuenow={user.user.feelingValue}
                                  aria-valuemin="0"
                                  aria-valuemax="100"
                                >
                                  {user.user.feelingValue}%
                                </div>
                              </div>
                              ...
                              <div className="progress mb-3 progressbarCharacterType">
                                <div
                                  ...
                                  aria-valuenow={user.user.judgingValue}
                                  aria-valuemin="0"
                                  aria-valuemax="100"
                                >
                                  {user.user.judgingValue}%
                                </div>
                                <div
                                  className="progress-bar progress-bar-striped bg-danger"
                                  role="progressbar"
                                  ...
                                  aria-valuenow={user.user.perceivingValue}
                                  aria-valuemin="0"
                                  aria-valuemax="100"
                                >
                                  {user.user.perceivingValue}%
                                </div>
                              </div>
                            </div>
                          </div>
